...
class StateReader:
    ...
    def __init__(self):
        ...
        year = format(datetime.today().year - 1)
    ...
    def income_state_yearly(self, code):
        ...
        try:
            ...
            success_log_dir = 'stateReaderFiles/income_success.txt'
            filed_log_dir = 'stateReaderFiles/income_filed.txt'
            include_coed_list_dir = 'stateReaderFiles/income_code_list.txt'
                ...
                try:
                    ...
                    with open(filed_log_dir, mode='a', newline='') as file_filed_log:
                        writer = csv.DictWriter(file_filed_log,
                                                fieldnames=['comp_nm', 'code', 'type', 'target_nm', 'curr_year',
                                                            'last_year', 'year_before'])
            ...
            # print(str(logging.error(traceback.format_exc())))
            with open('stateReaderFiles/no_code_income.txt', mode='a') as f:
                f.write('' + code + '\n')
    ...
    def financial_state_yearly(self, code):  # year : 2020 => 2019
        try:
            ...
            success_log_dir = 'stateReaderFiles/statements_success.txt'
            filed_log_dir = 'stateReaderFiles/statements_filed.txt'
            include_coed_list_dir = 'stateReaderFiles/state_code_list.txt'
            ...
            def fin_filtering(query_str: str, comp_code: str, target_nm: str, comp_nm: str):
                ...
                try:
                    ...
                    with open(filed_log_dir, mode='a', newline='') as file_filed_log:
                        writer = csv.DictWriter(file_filed_log,
                                                fieldnames=['comp_nm', 'code', 'target_nm', 'curr_year', 'last_year',
                                                            'year_before'])
                        writer.writerow(filed_dict)
                        # print(str(logging.error(traceback.format_exc())))
                        print('<재무 항목 취득실패>')
            ...
            # print(str(logging.error(traceback.format_exc())))
            with open('stateReaderFiles/no_code_fin.txt', mode='a') as f:
                f.write('' + code + '\n')
