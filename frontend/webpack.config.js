...
module.exports = {
    ...
    // 번들링이 무거워질경우 정적,동적 스플리팅을 고려하기. 번들 파일을 splitting 하여 다운로드하는데 걸리는 체감 시간을 줄일수 있다. 
    /*
       entry: {
       index : './src/index.js',
        ...
        rules: [
            {
                ...
                use: [
                    {
                        // 웹팩은 기본적으로 자바스크립트와 JSON 만 빌드할수 있다. 바벨은 자바스크립트가 아닌 다른 자원(HTML, CSS, Image)를 빌드할수 있도록
                        // 도와주는 속성이다. 일종의 번역기인 샘이다.
